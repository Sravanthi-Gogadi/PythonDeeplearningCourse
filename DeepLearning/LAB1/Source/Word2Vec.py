...
def fetch_words_data():
    ...
    with open("eng_news_2005.txt",encoding="utf8") as f:
        data = f.read().translate(tr)
...
with tf.Session() as sess:
    ...
    for step in range(num_steps):
        ...
        empty, loss_val, summary = sess.run([trainer, loss, summa], feed_dict=feed_dict)
        # Write logs at every iteration
        summary_writer.add_summary(summary, num_steps * batch_size + step)
